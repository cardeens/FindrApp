...
function GetBusinesses() {
    $.ajax({
        ...
        console.log(lat)
        console.log(lng)
        var queryURLinput = 'https://cors-anywhere.herokuapp.com/https://api.yelp.com/v3/businesses/search?latitude=' + lat + '&longitude=' + lng + '&radius=40000&limit=50&categories=restaurants,food';
...
$("#submitBtn").click(function (event) {
    ...
    {
        var searchURL = 'https://cors-anywhere.herokuapp.com/https://api.yelp.com/v3/businesses/search?location=' + city + '&radius=' + radius + '&limit=50&categories=restaurants,food';;
